...
export const Sidebar = React.memo(function Sidebar({ 
  ...
  return (
    <aside id="main-navigation" role="navigation" aria-label="Menu de navegação principal"
      className={cn('flex flex-col h-screen h-[100dvh] border-r border-border bg-sidebar shrink-0 transition-[width] duration-300 ease-in-out overflow-hidden', collapsed ? 'w-[var(--sidebar-w-collapsed)]' : 'w-[var(--sidebar-w)]')}>
