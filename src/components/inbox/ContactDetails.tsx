...
export function ContactDetails({ conversation, onClose }: ContactDetailsProps) {
  ...
  return (
    <motion.div
      ...
      className="w-[380px] h-full min-h-0 shrink-0 bg-black border-l border-border flex flex-col overflow-hidden"
    >
      <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-black shrink-0">
