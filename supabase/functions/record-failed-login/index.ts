...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Só e-mail sintaticamente válido vira linha em login_attempts: sem isto qualquer
    // string distinta criava uma linha nova e contornava o limite por e-mail (cubic P2).
