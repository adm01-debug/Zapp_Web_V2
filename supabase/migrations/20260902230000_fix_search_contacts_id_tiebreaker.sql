...
-- O corpo abaixo foi extraido de pg_get_functiondef da funcao viva em producao
-- em 03/09, entao este arquivo e a unica fonte fiel para replay.
...
RETURNS TABLE(
  id uuid, name text, nickname text, surname text, job_title text, company text,
